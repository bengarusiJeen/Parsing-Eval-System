...
from backend.app.models.document_models import BlockResult, DocumentResult, Score
from backend.app.core.utils import collect_files_dirs_to_test, find_document_file, tokenize
from backend.app.core.substitutions import SubstitutionTable
from backend.app.pipeline import gt_loader
from backend.app.pipeline.diagnostics import run_diagnostics, DIAGNOSTICS_PP_FILENAME
...
from backend.app.pipeline.reporting import print_result, print_summary, save_json_report
...
def main() -> None:
    ...
    sub_table = SubstitutionTable.load(Path(__file__).parent.parent / "core" / "substitutions.json")
